...
export const supportedDataTypes: DataType[] = [
	...
	},
	{
		...
		dhis2Fields: ["PHONE_NUMBER", "TEXT"] as any,
		supportedParams: [
			{
				type: "text",
				label: "Format",
